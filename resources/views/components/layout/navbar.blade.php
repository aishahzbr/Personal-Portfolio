    ...
    <div class="flex -mx-4 items-center justify-between relative">
      <div class="pr-4 w-60 max-w-full">
        <a href="/" class="w-full flex items-center py-2">
          <img
            src="{{ url('/img/logo-dark.png') }}"
            alt="logo"
            class="w-[90px] lg:w-[64px] inline-block dark:hidden"
          />
          <img
          ...
          />
          <span class="text-xl xl:text-xl font-bold text-[#0c7187] dark:text-white">AishahZ.</span>
        </a>
      </div>
