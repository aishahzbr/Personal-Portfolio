    ...
    <div class="flex flex-wrap -mx-4">
      <div class="w-full lg:w-5/12 px-4">
        <div class="hero-content">
          ...
          >
            My name is <span class="rounded-md text-amber-600">Aishah. <br/></span>
          </h1>
          <p class="text-base mb-8 max-w-[520px]">
            A software development student. <br/>
            A novice who's eager to learn new things.
            <a
              class="text-primary font-bold no-underline hover:underline underline-offset-2 decoration-2 decoration-primary"
              href="https://youtube.com/TheCodeholic" target="_blank"></a><br>
          </p>
